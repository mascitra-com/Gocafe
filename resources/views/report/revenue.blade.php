	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body table-responsive table-full">
				...
				<table class="table table-hover table-stripped table-bordered" id="revenue">
					<thead>
						<tr>
        ...
        $(document).ready( function () {
            ...
            $('input[name="daterange"]').daterangepicker(
                ...
                function(start, end, label) {
                    ...
                    get_revenue_json(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'), payment_type);
                });
            $('select#payment_type').on('change', function (e) {
                ...
                get_revenue_json(date[0], date[1], payment_type);
            });
        });
        function get_revenue_json(start, end, payment_type) {
            $.ajax({
                url: '/filter_revenue/' + start + '/' + end + '/' + payment_type,
                dataType: 'json',
                success: function (response) {
                    $('#revenue').find('tbody').empty();
                    var total = 0;
