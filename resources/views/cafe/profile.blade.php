                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="shop_category_id" id="shop_category_id" class="form-control">
                                            ...
                                            @foreach($shop_cat as $category)
                                                <option value="{{ $category->id }}" {{ (isset($cafe) && $category->id == $cafe->shop_category_id) ? 'selected' : '' }}>{{ $category->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="panel-body box-center">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <img src="{{($cafe != NULL) ? url($logo) : ''}}" class="image-fit img-circle" width="150px" alt="foto">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <img src="{{($cafe != NULL) ? url($cover) : ''}}" class="image-fit img-rounded" width="400px" alt="foto">
                                    <div class="break-10"></div>
