		...
		<div class="col-xs-12 col-md-8">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<form action="{{ URL('cafe/profile') }}" method="POST">
                        {{ csrf_field() }}
                        @if (count($errors) > 0)
                        ...
                        <div class="form-group">
							...
							<input type="text" class="form-control" name="name" placeholder="Cafe Name" value="{{ old('name') }}">
						</div>
						<div class="form-group">
							<label for="">Description</label>
							<textarea name="description" class="form-control" placeholder="Cafe Description">{{ old('description') }}</textarea>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="close_hours" placeholder="Close Hours" value="{{ old('close_hours') }}">
								</div>
							</div>
						</div>
						<div class="form-group">
